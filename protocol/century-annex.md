...
| weights BTC/ETH/GOLD/OIL/CU/CNH/USD | 20/15/15/10/10/15/15 |
...
hypothetical year-1 TWAP fixes: BTC $75,000 · ETH $2,200 · GOLD $4,400 · OIL $85 · CU $14,500/t · USD/CNY 7.00 · JISDOR 19,000.

1. mark quantities to market: I(t₁) = Σ qᵢ·Pᵢ = $107,506.92
2. price in bitcoin: S(t₁) = I/X = 107,506.92 / 75,000 = 1.433426 BTC
3. collar [S₀·0.85, S₀·1.35] = [1.357264, 2.155654] → 1.433426 passes unclamped
...
reading of this year: the basket grew 7.5% but bitcoin grew 19.8% — the sat floor binds and the tenant owes the same sats as year 0, worth more dollars. the lease is behaving as a bitcoin-standard obligation, exactly as designed.

## 4. fix sources

per the [[century index]] §3 table: Pyth primary (BTC/USD, ETH/USD, XAU/USD, USD/CNH), ICE Brent and LME copper settles primary for the physical legs, institutional fallbacks per the T3 waterfall. TWAP = trailing 365 calendar days, last published value carried through market closures.
