...
on the [[soft3]] ladder this whole model is a [[dialect]] — an agreed convention of sentences and motifs over words and links. the tokens are words, the bonds are links, the templates are motifs, and every committed batch is a [[signal]]. the running implementation is [[orgs]] (signal studio on cyberia.my/world).
